...
/**
 * A ConcreteDecorator: adds sucuk sausage to whatever it is wrapped around.
 * <p>
 * The class knows its own name and its own price. That is the difference between a topping
 * and a parameter: repricing sucuk sausage is an edit here and nowhere else.
 */
public class Sausage extends Topping {

    public Sausage(Toastable component) {
        super(component, "Sucuk sausage", 3);
    }
}
